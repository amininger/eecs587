...
#PBS -S /bin/sh
#PBS -N AM-mid
#PBS -l feature=xeon5650,qos=flux,nodes=3:ppn=12,walltime=1:30:00,mem=4gb
...
mpirun -np 1 launch ../../agents/qt_mid.soar
...
do
  ...
  do
    ...
    mpirun -np $np launch 10 $use_var 0 ../../agents/qt_mid.soar
  done
done
