...
should be as quick as possible. This places strict constraints on the
...
large number as the lifetime of the agent increases. Our goal for this project is to implement
...
Each worker holds a window of episodes that is some subinterval of the agent's history. 
